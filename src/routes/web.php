...
Route::post('/profile/edit/social', 'EditProfileController@social');
Route::put('/profile/edit/profile', 'EditProfileController@profile');
...
Route::middleware(['dashboardperms'])->group(function (){
    ...
    Route::get('/dashboard/articles/edit/{id}/history/{hid}', 'DashboardController@show_history');
    Route::get('/dashboard/articles/edit/{id}/history/{hid}/revert', 'DashboardPostController@revert_edit');
    ...
    Route::get('/dashboard/articles/clearcomments/{id}', 'DashboardSettingsController@clear_comments');
