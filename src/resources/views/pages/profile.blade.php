...
<div id="fh5co-main">
        ...
        <div id="fh5co-board" data-columns>
            ...
            <a href="{{url('profile/'.$user->name.'/posts')}}">{{count($posts)}} {{ count($posts) == '1' ? 'post' : 'posts' }}</a> | <a href="{{url('profile/'.$user->name.'/comments')}}">{{count($comments)}} {{ count($comments) == '1' ? 'comment' : 'comments' }}</a>
